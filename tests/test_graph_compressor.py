...
def test_yaml_compression_basic():
    ...
    graph_data = {
        "matched_nodes": [
            {"id": "node:test:123", "domain": "test", "type": "entity", "content": "This is a very long content that should be compressed for token efficiency"}
        ],
        "resolved_edges": [
            {"source": "node:test:123", "target": "node:other:456", "relation_type": "linked"}
        ]
    }
...
def test_yaml_compression_content_summary():
    ...
    graph_data = {
        "matched_nodes": [
            {"id": "node:test:123", "domain": "test", "type": "entity", "content": "This is a very long content that exceeds the 50 character limit for summaries"}
        ],
        "resolved_edges": []
    }
...
def test_yaml_compression_stopwords():
    ...
    graph_data = {
        "matched_nodes": [
            {"id": "node:test:123", "domain": "test", "type": "entity", "content": "This is a test content with many stopwords like the and a an"}
        ],
        "resolved_edges": []
    }
...
def test_yaml_compression_telegraphic():
    ...
    graph_data = {
        "matched_nodes": [
            {"id": "node:test:123", "domain": "documentation", "type": "entity", "content": "The documentation describes the architecture and implementation details"},
            {"id": "node:test:456", "domain": "documentation", "type": "chunk", "content": "Implementation follows best practices and design patterns"}
        ],
        "resolved_edges": [
            {"source": "node:test:123", "target": "node:test:456", "relation_type": "linked"}
        ]
    }
